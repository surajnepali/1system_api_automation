...
describe('Create New Bidding API Testing', () => {
    ...
    describe('With Login', () => {
        ...
        describe('User is an approved Driver and tries to create Bidding', () => {
            ...
            describe('When user tries to create bid without switching to driver role', () => {
                ...
                describe('Vendor tries to create a bidding', () => {
                ...
                describe('User tries to create a bidding', () => {
            ...
            describe('When driver tries to re-create the created Bidding', () => {
    ...
    describe('Without Login', () => {
        ...
        it('should throw error on trying to create a Bid', () => {
            createBidding('', gigId, createBidData).then((response) => {
