...
export const vendorSuccessMessages = {
    ...
    vendorApplicationEdited: 'Successfully updated',
    applicationRetrieved: 'Successfully retrieved data',
};
...
export const userSuccessMessages = {
    ...
    userSoftDeleted: 'Successfully deleted'
};
